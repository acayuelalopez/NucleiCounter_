...
public class UserDialogNuclei extends JDialog implements ActionListener, KeyListener {
	public JButton button;
	public MultiLineLabel label;
	static protected int xloc=-1, yloc=-1;
	private boolean escPressed;
	
	public UserDialogNuclei(String title, String text) {
		...
		ImageIcon icon = NucleiCounter_.createImageIcon("images/ok.png");
	...
	public UserDialogNuclei(String text) {
